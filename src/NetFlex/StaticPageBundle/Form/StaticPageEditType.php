...
use NetFlex\StaticPageBundle\Form\StaticPageSectionEditType;

class StaticPageEditType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        ->add('staticPageSections', CollectionType::class, [
            'entry_type' => StaticPageSectionEditType::class,
            'allow_add' => true,
            'allow_delete' => true,
            'delete_empty' => true,
            'by_reference' => false,
    ...
    {
        return 'dashboard_static_page_edit';
    }
}
