...
/**
 * Created by sevenmonks on 7/31/16.
 */
        ...
        options: {
            ...
            */
            ...
            messages: {
                ...
                minAllowedImageFileExceeded: 'Only one poster allowed',
                minAllowedAudioFileExceeded: 'Only one audio file allowed'
            },
    ...
    $.widget('blueimp.fileupload', $.blueimp.fileupload, {
        ...
        _renderPreviews: function (data) {
            data.context.find('.preview').each(function (index, elm) {
                if (data.files[index].imagePreview) {
                    $(elm).append(data.files[index].imagePreview);
                } else if (data.files[index].videoPreview) {
                    $(elm).append(data.files[index].videoPreview);
                } else {
                    $(elm).append(data.files[index].audioPreview);
                }
